function Player () {
  this.width = 50;
  this.height = 50;
  this.startingPoint = [256/5 * 2, 256/5*2];
...
Player.prototype.move = function (obstacles, activado) {
  var p = this;
  var vx = this.velX ;
  var vy = this.velY;
  var x = {};
...
// Returns true iff a and b overlap
 Player.prototype.collides = function(a, b, activado) {
    if (b.name == "SPIKES" && activado == true) {
